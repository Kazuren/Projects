...
namespace Core.ECS
{
  public partial class StopJumpingSystem : EntityComponentSystem.System
  {
    public StopJumpingSystem()
    {
    ...
    public override void PhysicsUpdate(double delta)
    {
      foreach (Entity entity in Entities)
      {
        ...
        StopJumpingCommand stopJumpingCommand = commandListenerComponent.GetCommand<StopJumpingCommand>();

        if (stopJumpingCommand != null)
        {
          stopJumpingCommand.Execute(entity);
        }
      }
    }
