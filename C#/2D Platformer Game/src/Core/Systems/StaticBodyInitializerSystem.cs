...
namespace Core.ECS
{
  public partial class StaticBodyInitializerSystem : EntityComponentSystem.System
  {
    public StaticBodyInitializerSystem()
    {
      ComponentSet = new ComponentSet()
      {
        Requirements = new HashSet<int> { TypeId<StaticBodyComponent>.Get(), TypeId<TransformComponent>.Get() },
    ...
    public override void OnEntityAdded(Entity entity)
    {
      ...
      StaticBody2D body = staticBodyComponent.Body;
